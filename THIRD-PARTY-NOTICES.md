...
- **Usage:** Head tracking source. We receive tracking data via the OpenTrack UDP protocol (port 4242). No OpenTrack code is bundled.
- **Bundled:** no.
...
- **Bundled:** yes (compiled into the plugin DLL).
