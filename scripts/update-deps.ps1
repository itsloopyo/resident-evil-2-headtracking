...
# including RE2. We deliberately vendor the universal asset, NOT the per-game
# RE2.zip nightly: the per-game zip bundles VR runtime DLLs (openvr_api.dll,
