...
:: --- CONFIG BLOCK ---
set "GAME_ID=resident-evil-2"
set "MOD_DISPLAY_NAME=RE2 Head Tracking"
set "MOD_DLLS=RE2HeadTracking.dll HeadTracking.ini"
set "MOD_INTERNAL_NAME=RE2HeadTracking"
set "MOD_VERSION=0.0.0"
set "STATE_FILE=.headtracking-state.json"
set "FRAMEWORK_TYPE=REFramework"
set "REFRAMEWORK_VENDOR_ZIP_NAME=RE2.zip"
set "MOD_CONTROLS=Controls:&echo   Home - Recenter head tracking&echo   End  - Toggle head tracking on/off&echo   PgUp - Cycle tracking mode&echo   PgDn - Toggle world/local yaw&echo   Ins  - Toggle reticle"
